...
const getLicensesFromXmlObject = (xmlObject) => {
...
const check = (xmlObject) => {
  const licensesFound = getLicensesFromXmlObject(xmlObject);
  // TODO: this line should be used on commands to validate.
  // validator.validate(options.unifiedList);
