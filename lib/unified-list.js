...
function check (options, xmlObject) {
  ...
  messages.print(approvedFound, messages.APPROVED_SEPARATOR());
  messages.print(notApprovedFound, messages.NOT_APPROVED_SEPARATOR());
  messages.print(unknown, messages.CLARIFICATION_SEPARATOR());
}
